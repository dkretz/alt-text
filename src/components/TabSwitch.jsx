...
export default function TabSwitch(props) {
  ...
  if(! url) {
    const iurl = props.html.match(/"dcterms\.source"\s+content="(.*?)"/ius)[1]; 
  ...
  return (
    <>
      <div id="teimain">
        <EditorCard html={props.html} setHtml={props.setHtml} />
        <PreviewCard url={url} html={props.html} dom={dom} image={image} setImage={setImage} />
